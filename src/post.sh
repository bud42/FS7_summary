...
for i in *;do
    cd /OUTPUTS/DATA/SUBJECTS/$i/surf
    ...
    echo "--hide surface" >> commands.txt
    echo "-f lh.inflated:annot=Schaefer2018_100Parcels_7Networks_order" >> commands.txt
    echo "-ss lh_lat_s100i.png -noquit" >> commands.txt
    echo "-cam azimuth 180" >> commands.txt
    echo "-ss lh_med_s100i.png -noquit" >> commands.txt
    echo "--hide surface" >> commands.txt
    echo "-f rh.inflated:annot=Schaefer2018_100Parcels_7Networks_order" >> commands.txt
    echo "-ss rh_lat_s100i.png -noquit" >> commands.txt
    echo "-cam azimuth 180" >> commands.txt
    echo "-ss rh_med_s100i.png -noquit" >> commands.txt
    echo "--hide surface" >> commands.txt
    echo "-f lh.pial:annot=Schaefer2018_100Parcels_7Networks_order" >> commands.txt
    echo "-ss lh_lat_s100.png -noquit" >> commands.txt
    echo "-cam azimuth 180" >> commands.txt
    echo "-ss lh_med_s100.png -noquit" >> commands.txt
    echo "--hide surface" >> commands.txt
    echo "-f rh.pial:annot=Schaefer2018_100Parcels_7Networks_order" >> commands.txt
...
convert /OUTPUTS/DATA/SUBJECTS/*/surf/montage*.png -bordercolor white -border 100x500 -page letter /OUTPUTS/report.pdf
